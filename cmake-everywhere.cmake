...
function(cme_port_feature port feature)
  cmake_parse_arguments(FEATURE "" "SUMMARY"
    "GN_ARGS;GN_CONFIRM;GN_TARGETS;IMPORT_TARGETS;OPTIONS;DEPENDS;IMPLIES;CONFLICTS;EXCLUDES;SYSTEM_HEADERS;SYSTEM_SYMBOLS;SYSTEM_CODE;SYSTEM_COMPONENT;CONFIGURE_ARGS;PATCHES;TARGETS;TREES;DEFAULT"
    ${ARGN})
  ...
  endforeach()
  cme_export_line(${port} "${said})")
  foreach(field GN_ARGS GN_CONFIRM GN_TARGETS IMPORT_TARGETS OPTIONS DEPENDS
                SUMMARY IMPLIES
                CONFLICTS
...
function(cme_build_port port package version exact)
  ...
  elseif(configure)
    ...
    if(configure STREQUAL "cmake")
      ...
      cme_cmake_prefix_export(${port} "${entry}")
    else()
