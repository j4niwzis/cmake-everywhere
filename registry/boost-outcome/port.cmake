# Written by tools/boost-ports.py from what boostorg/outcome
...
cme_declare_port(
  NAME boost-outcome
  PROVIDES boost_outcome BoostOutcome
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_outcome
  TARGETS Boost::outcome
  DEPENDS boost-config boost-exception boost-headers boost-system boost-throw-exception
)
...
cme_port_feature(boost-outcome modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-outcome
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/outcome)
else()
  cme_port_source(boost-outcome
    GITHUB_REPOSITORY boostorg/outcome
