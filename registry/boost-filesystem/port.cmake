# Written by tools/boost-ports.py from what boostorg/filesystem
...
cme_declare_port(
  ...
  PROVIDES boost_filesystem BoostFilesystem
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_filesystem
  TARGETS Boost::filesystem
  DEPENDS boost-assert boost-atomic boost-config boost-container-hash boost-core boost-detail boost-io boost-iterator boost-predef boost-scope boost-smart-ptr boost-system boost-type-traits boost-winapi
)
...
cme_port_feature(boost-filesystem modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-filesystem
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/filesystem)
else()
  cme_port_source(boost-filesystem
