# Written by tools/boost-ports.py from what boostorg/bind
...
cme_declare_port(
  NAME boost-bind
  PROVIDES boost_bind BoostBind
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_bind
  TARGETS Boost::bind
...
cme_port_feature(boost-bind modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-bind
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/bind)
else()
  cme_port_source(boost-bind
