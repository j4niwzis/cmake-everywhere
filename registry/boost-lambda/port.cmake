# Written by tools/boost-ports.py from what boostorg/lambda
...
cme_declare_port(
  NAME boost-lambda
  PROVIDES boost_lambda BoostLambda
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_lambda
  TARGETS Boost::lambda
  DEPENDS boost-config boost-core boost-detail boost-iterator boost-mpl boost-preprocessor boost-tuple boost-type-traits boost-utility
)
...
cme_port_feature(boost-lambda modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-lambda
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/lambda)
else()
  cme_port_source(boost-lambda
    GITHUB_REPOSITORY boostorg/lambda
