# Written by tools/boost-ports.py from what boostorg/detail
...
cme_declare_port(
  NAME boost-detail
  PROVIDES boost_detail BoostDetail
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_detail
  TARGETS Boost::detail
  DEPENDS boost-config boost-core boost-preprocessor boost-type-traits
)
...
cme_port_feature(boost-detail modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-detail
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/detail)
else()
  cme_port_source(boost-detail
