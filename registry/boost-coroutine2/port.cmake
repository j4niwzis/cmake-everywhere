# Written by tools/boost-ports.py from what boostorg/coroutine2
...
cme_declare_port(
  ...
  PROVIDES boost_coroutine2 BoostCoroutine2
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_coroutine2
  TARGETS Boost::coroutine2
  DEPENDS boost-assert boost-config boost-context
)
...
cme_port_feature(boost-coroutine2 modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-coroutine2
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/coroutine2)
else()
  cme_port_source(boost-coroutine2
    GITHUB_REPOSITORY boostorg/coroutine2
