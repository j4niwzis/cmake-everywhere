# Written by tools/boost-ports.py from what boostorg/ratio
...
cme_declare_port(
  NAME boost-ratio
  PROVIDES boost_ratio BoostRatio
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_ratio
  TARGETS Boost::ratio
)
...
cme_port_feature(boost-ratio modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-ratio
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/ratio)
else()
  cme_port_source(boost-ratio
