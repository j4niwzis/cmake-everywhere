# Written by tools/boost-ports.py from what boostorg/json
...
cme_declare_port(
  NAME boost-json
  PROVIDES boost_json BoostJson
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_json
  TARGETS Boost::json
  DEPENDS boost-assert boost-config boost-container boost-container-hash boost-core boost-describe boost-endian boost-mp11 boost-system boost-throw-exception
)
...
cme_port_feature(boost-json modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-json
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/json)
else()
  cme_port_source(boost-json
