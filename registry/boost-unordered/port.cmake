# Written by tools/boost-ports.py from what boostorg/unordered
...
cme_declare_port(
  ...
  PROVIDES boost_unordered BoostUnordered
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_unordered
  TARGETS Boost::unordered
  DEPENDS boost-assert boost-config boost-container-hash boost-core boost-mp11 boost-predef boost-throw-exception
)
...
cme_port_feature(boost-unordered modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-unordered
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/unordered)
else()
  cme_port_source(boost-unordered
