# Written by tools/boost-ports.py from what boostorg/units
...
cme_declare_port(
  NAME boost-units
  PROVIDES boost_units BoostUnits
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_units
  TARGETS Boost::units
  DEPENDS boost-assert boost-config boost-core boost-integer boost-io boost-lambda boost-math boost-mpl boost-preprocessor boost-type-traits boost-typeof
)
...
cme_port_feature(boost-units modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-units
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/units)
else()
  cme_port_source(boost-units
    GITHUB_REPOSITORY boostorg/units
