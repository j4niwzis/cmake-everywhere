# Written by tools/boost-ports.py from what boostorg/uuid
...
cme_declare_port(
  NAME boost-uuid
  PROVIDES boost_uuid BoostUuid
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_uuid
  TARGETS Boost::uuid
  DEPENDS boost-assert boost-config boost-throw-exception boost-type-traits
)
...
cme_port_feature(boost-uuid modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-uuid
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/uuid)
else()
  cme_port_source(boost-uuid
