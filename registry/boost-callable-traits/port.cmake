# Written by tools/boost-ports.py from what boostorg/callable_traits
...
cme_declare_port(
  ...
  PROVIDES boost_callable_traits BoostCallableTraits
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_callable_traits
  TARGETS Boost::callable_traits
)
...
cme_port_feature(boost-callable-traits modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-callable-traits
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/callable_traits)
else()
  cme_port_source(boost-callable-traits
    GITHUB_REPOSITORY boostorg/callable_traits
