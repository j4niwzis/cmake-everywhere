# Written by tools/boost-ports.py from what boostorg/atomic
...
cme_declare_port(
  NAME boost-atomic
  PROVIDES boost_atomic BoostAtomic
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_atomic
  TARGETS Boost::atomic
  DEPENDS boost-align boost-assert boost-config boost-predef boost-preprocessor boost-type-traits boost-winapi
)
...
cme_port_feature(boost-atomic modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-atomic
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/atomic)
else()
  cme_port_source(boost-atomic
