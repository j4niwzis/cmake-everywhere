# Written by tools/boost-ports.py from what boostorg/type_traits
...
cme_declare_port(
  ...
  PROVIDES boost_type_traits BoostTypeTraits
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_type_traits
  TARGETS Boost::type_traits
...
cme_port_feature(boost-type-traits modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-type-traits
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/type_traits)
else()
  cme_port_source(boost-type-traits
