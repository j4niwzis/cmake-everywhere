# Written by tools/boost-ports.py from what boostorg/fusion
...
cme_declare_port(
  NAME boost-fusion
  PROVIDES boost_fusion BoostFusion
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_fusion
  TARGETS Boost::fusion
  DEPENDS boost-config boost-container-hash boost-core boost-function-types boost-mpl boost-preprocessor boost-tuple boost-type-traits boost-typeof boost-utility
)
...
cme_port_feature(boost-fusion modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-fusion
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/fusion)
else()
  cme_port_source(boost-fusion
