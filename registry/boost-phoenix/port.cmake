# Written by tools/boost-ports.py from what boostorg/phoenix
...
cme_declare_port(
  NAME boost-phoenix
  PROVIDES boost_phoenix BoostPhoenix
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_phoenix
  TARGETS Boost::phoenix
  DEPENDS boost-assert boost-bind boost-config boost-core boost-function boost-fusion boost-mpl boost-predef boost-preprocessor boost-proto boost-range boost-smart-ptr boost-type-traits boost-utility
)
...
cme_port_feature(boost-phoenix modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-phoenix
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/phoenix)
else()
  cme_port_source(boost-phoenix
