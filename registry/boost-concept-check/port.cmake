# Written by tools/boost-ports.py from what boostorg/concept_check
...
cme_declare_port(
  ...
  PROVIDES boost_concept_check BoostConceptCheck
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_concept_check
  TARGETS Boost::concept_check
  DEPENDS boost-config boost-preprocessor boost-type-traits
)
...
cme_port_feature(boost-concept-check modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-concept-check
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/concept_check)
else()
  cme_port_source(boost-concept-check
