# Written by tools/boost-ports.py from what boostorg/openmethod
...
cme_declare_port(
  ...
  PROVIDES boost_openmethod BoostOpenmethod
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_openmethod
  TARGETS Boost::openmethod
  DEPENDS boost-assert boost-config boost-core boost-dynamic-bitset boost-headers boost-mp11 boost-preprocessor boost-smart-ptr
)
...
cme_port_feature(boost-openmethod modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-openmethod
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/openmethod)
else()
  cme_port_source(boost-openmethod
    GITHUB_REPOSITORY boostorg/openmethod
