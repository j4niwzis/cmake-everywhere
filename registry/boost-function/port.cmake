# Written by tools/boost-ports.py from what boostorg/function
...
cme_declare_port(
  NAME boost-function
  PROVIDES boost_function BoostFunction
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_function
  TARGETS Boost::function
  DEPENDS boost-assert boost-bind boost-config boost-core boost-throw-exception
)
...
cme_port_feature(boost-function modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-function
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/function)
else()
  cme_port_source(boost-function
