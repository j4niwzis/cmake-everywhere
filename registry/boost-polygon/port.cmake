# Written by tools/boost-ports.py from what boostorg/polygon
...
cme_declare_port(
  NAME boost-polygon
  PROVIDES boost_polygon BoostPolygon
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_polygon
  TARGETS Boost::polygon
...
cme_port_feature(boost-polygon modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-polygon
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/polygon)
else()
  cme_port_source(boost-polygon
    GITHUB_REPOSITORY boostorg/polygon
