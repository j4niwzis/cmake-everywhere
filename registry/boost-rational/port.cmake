# Written by tools/boost-ports.py from what boostorg/rational
...
cme_declare_port(
  NAME boost-rational
  PROVIDES boost_rational BoostRational
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_rational
  TARGETS Boost::rational
  DEPENDS boost-assert boost-config boost-core boost-integer boost-throw-exception boost-type-traits boost-utility
)
...
cme_port_feature(boost-rational modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-rational
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/rational)
else()
  cme_port_source(boost-rational
