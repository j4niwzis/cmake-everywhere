# Written by tools/boost-ports.py from what boostorg/pool
...
cme_declare_port(
  NAME boost-pool
  PROVIDES boost_pool BoostPool
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_pool
  TARGETS Boost::pool
  DEPENDS boost-assert boost-config boost-integer boost-throw-exception boost-type-traits boost-winapi
)
...
cme_port_feature(boost-pool modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-pool
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/pool)
else()
  cme_port_source(boost-pool
