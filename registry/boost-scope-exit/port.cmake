# Written by tools/boost-ports.py from what boostorg/scope_exit
...
cme_declare_port(
  ...
  PROVIDES boost_scope_exit BoostScopeExit
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_scope_exit
  TARGETS Boost::scope_exit
  DEPENDS boost-config boost-function boost-preprocessor boost-type-traits boost-typeof
)
...
cme_port_feature(boost-scope-exit modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-scope-exit
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/scope_exit)
else()
  cme_port_source(boost-scope-exit
    GITHUB_REPOSITORY boostorg/scope_exit
