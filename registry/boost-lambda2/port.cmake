# Written by tools/boost-ports.py from what boostorg/lambda2
...
cme_declare_port(
  NAME boost-lambda2
  PROVIDES boost_lambda2 BoostLambda2
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_lambda2
  TARGETS Boost::lambda2
)
...
cme_port_feature(boost-lambda2 modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-lambda2
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/lambda2)
else()
  cme_port_source(boost-lambda2
    GITHUB_REPOSITORY boostorg/lambda2
