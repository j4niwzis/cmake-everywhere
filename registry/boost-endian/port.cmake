# Written by tools/boost-ports.py from what boostorg/endian
...
cme_declare_port(
  NAME boost-endian
  PROVIDES boost_endian BoostEndian
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_endian
  TARGETS Boost::endian
...
cme_port_feature(boost-endian modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-endian
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/endian)
else()
  cme_port_source(boost-endian
