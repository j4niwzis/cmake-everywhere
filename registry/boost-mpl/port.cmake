# Written by tools/boost-ports.py from what boostorg/mpl
...
cme_declare_port(
  NAME boost-mpl
  PROVIDES boost_mpl BoostMpl
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_mpl
  TARGETS Boost::mpl
  DEPENDS boost-config boost-core boost-predef boost-preprocessor boost-type-traits boost-utility
)
...
cme_port_feature(boost-mpl modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-mpl
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/mpl)
else()
  cme_port_source(boost-mpl
