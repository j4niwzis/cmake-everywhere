# Written by tools/boost-ports.py from what boostorg/interprocess
...
cme_declare_port(
  ...
  PROVIDES boost_interprocess BoostInterprocess
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_interprocess
  TARGETS Boost::interprocess
  DEPENDS boost-assert boost-config boost-container boost-intrusive boost-move boost-winapi
)
...
cme_port_feature(boost-interprocess modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-interprocess
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/interprocess)
else()
  cme_port_source(boost-interprocess
