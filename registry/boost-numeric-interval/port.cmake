# Written by tools/boost-ports.py from what boostorg/interval
...
cme_declare_port(
  NAME boost-numeric-interval
  PROVIDES boost_numeric_interval BoostNumericInterval
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_numeric_interval
  TARGETS Boost::numeric_interval
  DEPENDS boost-config boost-detail boost-logic
)
...
cme_port_feature(boost-numeric-interval modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-numeric-interval
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/numeric/interval)
else()
  cme_port_source(boost-numeric-interval
    GITHUB_REPOSITORY boostorg/interval
