# Written by tools/boost-ports.py from what boostorg/yap
...
cme_declare_port(
  NAME boost-yap
  PROVIDES boost_yap BoostYap
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_yap
  TARGETS Boost::yap
  DEPENDS boost-hana boost-preprocessor boost-type-index
)
...
cme_port_feature(boost-yap modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-yap
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/yap)
else()
  cme_port_source(boost-yap
    GITHUB_REPOSITORY boostorg/yap
