# Written by tools/boost-ports.py from what boostorg/foreach
...
cme_declare_port(
  NAME boost-foreach
  PROVIDES boost_foreach BoostForeach
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_foreach
  TARGETS Boost::foreach
  DEPENDS boost-config boost-core boost-iterator boost-mpl boost-range boost-type-traits
)
...
cme_port_feature(boost-foreach modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-foreach
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/foreach)
else()
  cme_port_source(boost-foreach
    GITHUB_REPOSITORY boostorg/foreach
