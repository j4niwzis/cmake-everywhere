# Written by tools/boost-ports.py from what boostorg/hana
...
cme_declare_port(
  NAME boost-hana
  PROVIDES boost_hana BoostHana
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_hana
  TARGETS Boost::hana
  DEPENDS boost-config boost-core boost-fusion boost-mpl boost-tuple
)
...
cme_port_feature(boost-hana modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-hana
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/hana)
else()
  cme_port_source(boost-hana
