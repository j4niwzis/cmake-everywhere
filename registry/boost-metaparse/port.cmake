# Written by tools/boost-ports.py from what boostorg/metaparse
...
cme_declare_port(
  ...
  PROVIDES boost_metaparse BoostMetaparse
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_metaparse
  TARGETS Boost::metaparse
  DEPENDS boost-config boost-mpl boost-predef boost-preprocessor boost-type-traits
)
...
cme_port_feature(boost-metaparse modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-metaparse
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/metaparse)
else()
  cme_port_source(boost-metaparse
    GITHUB_REPOSITORY boostorg/metaparse
