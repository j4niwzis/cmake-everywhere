# Written by tools/boost-ports.py from what boostorg/math
...
cme_declare_port(
  NAME boost-math
  PROVIDES boost_math BoostMath
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_math
  TARGETS Boost::math
  DEPENDS boost-assert boost-concept-check boost-config boost-core boost-integer boost-lexical-cast boost-predef boost-random boost-throw-exception
)
...
cme_port_feature(boost-math modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-math
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/math)
else()
  cme_port_source(boost-math
