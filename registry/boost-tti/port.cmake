# Written by tools/boost-ports.py from what boostorg/tti
...
cme_declare_port(
  NAME boost-tti
  PROVIDES boost_tti BoostTti
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_tti
  TARGETS Boost::tti
  DEPENDS boost-config boost-function-types boost-mpl boost-preprocessor boost-type-traits
)
...
cme_port_feature(boost-tti modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-tti
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/tti)
else()
  cme_port_source(boost-tti
