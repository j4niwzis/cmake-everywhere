# Written by tools/boost-ports.py from what boostorg/container_hash
...
cme_declare_port(
  ...
  PROVIDES boost_container_hash BoostContainerHash
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_container_hash
  TARGETS Boost::container_hash
  DEPENDS boost-config boost-describe boost-mp11
)
...
cme_port_feature(boost-container-hash modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-container-hash
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/container_hash)
else()
  cme_port_source(boost-container-hash
