# Written by tools/boost-ports.py from what boostorg/safe_numerics
...
cme_declare_port(
  ...
  PROVIDES boost_safe_numerics BoostSafeNumerics
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_safe_numerics
  TARGETS Boost::safe_numerics
  DEPENDS boost-concept-check boost-config boost-core boost-integer boost-logic boost-mp11
)
...
cme_port_feature(boost-safe-numerics modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-safe-numerics
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/safe_numerics)
else()
  cme_port_source(boost-safe-numerics
    GITHUB_REPOSITORY boostorg/safe_numerics
