# Written by tools/boost-ports.py from what boostorg/locale
...
cme_declare_port(
  NAME boost-locale
  PROVIDES boost_locale BoostLocale
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_locale
  TARGETS Boost::locale
  DEPENDS boost-assert boost-charconv boost-config boost-core boost-iterator boost-predef boost-thread
)
...
cme_port_feature(boost-locale modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-locale
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/locale)
else()
  cme_port_source(boost-locale
    GITHUB_REPOSITORY boostorg/locale
