# Written by tools/boost-ports.py from what boostorg/convert
...
cme_declare_port(
  NAME boost-convert
  PROVIDES boost_convert BoostConvert
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_convert
  TARGETS Boost::convert
  DEPENDS boost-config boost-core boost-function-types boost-lexical-cast boost-math boost-mpl boost-optional boost-parameter boost-range boost-spirit boost-type-traits
)
...
cme_port_feature(boost-convert modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-convert
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/convert)
else()
  cme_port_source(boost-convert
    GITHUB_REPOSITORY boostorg/convert
