# Written by tools/boost-ports.py from what boostorg/icl
...
cme_declare_port(
  NAME boost-icl
  PROVIDES boost_icl BoostIcl
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_icl
  TARGETS Boost::icl
  DEPENDS boost-assert boost-concept-check boost-config boost-container boost-core boost-date-time boost-detail boost-iterator boost-move boost-mpl boost-range boost-rational boost-type-traits boost-utility
)
...
cme_port_feature(boost-icl modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-icl
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/icl)
else()
  cme_port_source(boost-icl
    GITHUB_REPOSITORY boostorg/icl
