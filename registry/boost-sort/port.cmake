# Written by tools/boost-ports.py from what boostorg/sort
...
cme_declare_port(
  NAME boost-sort
  PROVIDES boost_sort BoostSort
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_sort
  TARGETS Boost::sort
  DEPENDS boost-config boost-core boost-range boost-type-traits
)
...
cme_port_feature(boost-sort modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-sort
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/sort)
else()
  cme_port_source(boost-sort
    GITHUB_REPOSITORY boostorg/sort
