# Written by tools/boost-ports.py from what boostorg/histogram
...
cme_declare_port(
  ...
  PROVIDES boost_histogram BoostHistogram
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_histogram
  TARGETS Boost::histogram
  DEPENDS boost-config boost-core boost-mp11 boost-throw-exception boost-variant2
)
...
cme_port_feature(boost-histogram modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-histogram
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/histogram)
else()
  cme_port_source(boost-histogram
