# Written by tools/boost-ports.py from what boostorg/parser
...
cme_declare_port(
  NAME boost-parser
  PROVIDES boost_parser BoostParser
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_parser
  TARGETS Boost::parser
  DEPENDS boost-assert boost-hana boost-type-index
)
...
cme_port_feature(boost-parser modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-parser
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/parser)
else()
  cme_port_source(boost-parser
    GITHUB_REPOSITORY boostorg/parser
