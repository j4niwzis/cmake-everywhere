# Written by tools/boost-ports.py from what boostorg/compat
...
cme_declare_port(
  NAME boost-compat
  PROVIDES boost_compat BoostCompat
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_compat
  TARGETS Boost::compat
  DEPENDS boost-assert boost-config boost-throw-exception
)
...
cme_port_feature(boost-compat modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-compat
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/compat)
else()
  cme_port_source(boost-compat
    GITHUB_REPOSITORY boostorg/compat
