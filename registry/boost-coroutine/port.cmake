# Written by tools/boost-ports.py from what boostorg/coroutine
...
cme_declare_port(
  ...
  PROVIDES boost_coroutine BoostCoroutine
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_coroutine
  TARGETS Boost::coroutine
  DEPENDS boost-assert boost-config boost-context boost-core boost-exception boost-move boost-system boost-throw-exception boost-type-traits boost-utility
)
...
cme_port_feature(boost-coroutine modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-coroutine
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/coroutine)
else()
  cme_port_source(boost-coroutine
