# Written by tools/boost-ports.py from what boostorg/stl_interfaces
...
cme_declare_port(
  ...
  PROVIDES boost_stl_interfaces BoostStlInterfaces
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_stl_interfaces
  TARGETS Boost::stl_interfaces
  DEPENDS boost-assert boost-config
)
...
cme_port_feature(boost-stl-interfaces modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-stl-interfaces
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/stl_interfaces)
else()
  cme_port_source(boost-stl-interfaces
    GITHUB_REPOSITORY boostorg/stl_interfaces
