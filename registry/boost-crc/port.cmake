# Written by tools/boost-ports.py from what boostorg/crc
...
cme_declare_port(
  NAME boost-crc
  PROVIDES boost_crc BoostCrc
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_crc
  TARGETS Boost::crc
)
...
cme_port_feature(boost-crc modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-crc
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/crc)
else()
  cme_port_source(boost-crc
    GITHUB_REPOSITORY boostorg/crc
