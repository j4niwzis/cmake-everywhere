# Written by tools/boost-ports.py from what boostorg/tokenizer
...
cme_declare_port(
  ...
  PROVIDES boost_tokenizer BoostTokenizer
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_tokenizer
  TARGETS Boost::tokenizer
  DEPENDS boost-assert boost-config boost-iterator boost-mpl boost-throw-exception boost-type-traits
)
...
cme_port_feature(boost-tokenizer modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-tokenizer
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/tokenizer)
else()
  cme_port_source(boost-tokenizer
