# Written by tools/boost-ports.py from what boostorg/charconv
...
cme_declare_port(
  NAME boost-charconv
  PROVIDES boost_charconv BoostCharconv
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_charconv
  TARGETS Boost::charconv
...
cme_port_feature(boost-charconv modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-charconv
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/charconv)
else()
  cme_port_source(boost-charconv
