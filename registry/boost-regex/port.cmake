# Written by tools/boost-ports.py from what boostorg/regex
...
cme_declare_port(
  NAME boost-regex
  PROVIDES boost_regex BoostRegex
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_regex
  TARGETS Boost::regex
  DEPENDS boost-assert boost-config boost-predef boost-throw-exception
)
...
cme_port_feature(boost-regex modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-regex
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/regex)
else()
  cme_port_source(boost-regex
