# Written by tools/boost-ports.py from what boostorg/scope
...
cme_declare_port(
  NAME boost-scope
  PROVIDES boost_scope BoostScope
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_scope
  TARGETS Boost::scope
  DEPENDS boost-config boost-core boost-type-traits
)
...
cme_port_feature(boost-scope modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-scope
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/scope)
else()
  cme_port_source(boost-scope
    GITHUB_REPOSITORY boostorg/scope
