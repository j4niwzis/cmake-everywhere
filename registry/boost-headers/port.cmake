# Written by tools/boost-ports.py from what boostorg/headers
...
cme_declare_port(
  NAME boost-headers
  PROVIDES boost_headers BoostHeaders
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_headers
...
cme_port_feature(boost-headers modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-headers
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/headers)
else()
  cme_port_source(boost-headers
    GITHUB_REPOSITORY boostorg/headers
