# Written by tools/boost-ports.py from what boostorg/url
...
cme_declare_port(
  NAME boost-url
  PROVIDES boost_url BoostUrl
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_url
  TARGETS Boost::url
  DEPENDS boost-align boost-assert boost-config boost-core boost-headers boost-mp11 boost-optional boost-system boost-throw-exception boost-type-traits boost-variant2
)
...
cme_port_feature(boost-url modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-url
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/url)
else()
  cme_port_source(boost-url
