# Written by tools/boost-ports.py from what boostorg/multiprecision
...
cme_declare_port(
  ...
  PROVIDES boost_multiprecision BoostMultiprecision
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_multiprecision
  TARGETS Boost::multiprecision
  DEPENDS boost-assert boost-config boost-core boost-integer boost-lexical-cast boost-math boost-random
)
...
cme_port_feature(boost-multiprecision modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-multiprecision
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/multiprecision)
else()
  cme_port_source(boost-multiprecision
