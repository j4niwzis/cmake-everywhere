# Written by tools/boost-ports.py from what boostorg/optional
...
cme_declare_port(
  NAME boost-optional
  PROVIDES boost_optional BoostOptional
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_optional
  TARGETS Boost::optional
  DEPENDS boost-assert boost-config boost-core boost-throw-exception boost-type-traits
)
...
cme_port_feature(boost-optional modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-optional
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/optional)
else()
  cme_port_source(boost-optional
