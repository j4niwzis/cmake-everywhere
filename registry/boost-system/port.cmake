# Written by tools/boost-ports.py from what boostorg/system
...
cme_declare_port(
  NAME boost-system
  PROVIDES boost_system BoostSystem
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_system
  TARGETS Boost::system
  DEPENDS boost-assert boost-compat boost-config boost-throw-exception boost-variant2 boost-winapi
)
...
cme_port_feature(boost-system modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-system
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/system)
else()
  cme_port_source(boost-system
