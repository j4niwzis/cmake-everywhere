# Written by tools/boost-ports.py from what boostorg/dll
...
cme_declare_port(
  NAME boost-dll
  PROVIDES boost_dll BoostDll
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_dll
  TARGETS Boost::dll
  DEPENDS boost-assert boost-config boost-core boost-filesystem boost-predef boost-system boost-throw-exception boost-type-index boost-winapi
)
...
cme_port_feature(boost-dll modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-dll
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/dll)
else()
  cme_port_source(boost-dll
    GITHUB_REPOSITORY boostorg/dll
