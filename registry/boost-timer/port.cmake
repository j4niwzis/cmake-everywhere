# Written by tools/boost-ports.py from what boostorg/timer
...
cme_declare_port(
  NAME boost-timer
  PROVIDES boost_timer BoostTimer
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_timer
  TARGETS Boost::timer
  DEPENDS boost-config boost-io boost-predef
)
...
cme_port_feature(boost-timer modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-timer
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/timer)
else()
  cme_port_source(boost-timer
    GITHUB_REPOSITORY boostorg/timer
