# Written by tools/boost-ports.py from what boostorg/type_index
...
cme_declare_port(
  ...
  PROVIDES boost_type_index BoostTypeIndex
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_type_index
  TARGETS Boost::type_index
  DEPENDS boost-config boost-container-hash boost-throw-exception
)
...
cme_port_feature(boost-type-index modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-type-index
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/type_index)
else()
  cme_port_source(boost-type-index
