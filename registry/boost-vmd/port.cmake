# Written by tools/boost-ports.py from what boostorg/vmd
...
cme_declare_port(
  NAME boost-vmd
  PROVIDES boost_vmd BoostVmd
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_vmd
  TARGETS Boost::vmd
...
cme_port_feature(boost-vmd modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-vmd
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/vmd)
else()
  cme_port_source(boost-vmd
    GITHUB_REPOSITORY boostorg/vmd
