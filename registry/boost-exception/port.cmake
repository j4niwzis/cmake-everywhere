# Written by tools/boost-ports.py from what boostorg/exception
...
cme_declare_port(
  ...
  PROVIDES boost_exception BoostException
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_exception
  TARGETS Boost::exception
  DEPENDS boost-assert boost-config boost-core boost-smart-ptr boost-throw-exception boost-tuple boost-type-traits
)
...
cme_port_feature(boost-exception modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-exception
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/exception)
else()
  cme_port_source(boost-exception
