# Written by tools/boost-ports.py from what boostorg/pfr
...
cme_declare_port(
  NAME boost-pfr
  PROVIDES boost_pfr BoostPfr
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_pfr
  TARGETS Boost::pfr
)
...
cme_port_feature(boost-pfr modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-pfr
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/pfr)
else()
  cme_port_source(boost-pfr
