# Written by tools/boost-ports.py from what boostorg/decimal
...
cme_declare_port(
  NAME boost-decimal
  PROVIDES boost_decimal BoostDecimal
  VERSION 1.92.0
  FAMILY boost
  LICENSE BSL-1.0
  SYSTEM_PACKAGE boost_decimal
  TARGETS Boost::decimal
)
...
cme_port_feature(boost-decimal modules
...
if(CME_BOOST_ARCHIVE)
  cme_port_source(boost-decimal
    SOURCE_FROM boost-archive SOURCE_SUBDIR libs/decimal)
else()
  cme_port_source(boost-decimal
    GITHUB_REPOSITORY boostorg/decimal
