...
function(cme_meson_machine_file port out_file out_kind)
  ...
  set(cpp_args "")
  set(link_args "")
  # What this build type adds. -O3 and link-time optimisation are written
  # into the per-configuration flags, and a port compiled without them is a
  # port compiled without any of the tuning the program asked for -- and,
  # under LTO, an archive of machine code where the final link expected
  # bitcode.
